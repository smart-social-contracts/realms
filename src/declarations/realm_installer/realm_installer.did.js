export const idlFactory = ({ IDL }) => {
  return IDL.Service({
    ...
    'enqueue_deployment' : IDL.Func([IDL.Text], [IDL.Text], []),
    ...
    'get_deployment_job_status' : IDL.Func([IDL.Text], [IDL.Text], ['query']),
    'get_pending_deployments' : IDL.Func([], [IDL.Text], ['query']),
    'get_verification_report' : IDL.Func([IDL.Text], [IDL.Text], ['query']),
    'health' : IDL.Func([], [IDL.Text], ['query']),
    'info' : IDL.Func([], [IDL.Text], ['query']),
    'install_realm_backend' : IDL.Func([IDL.Text], [IDL.Text], []),
    'list_deployment_jobs' : IDL.Func([], [IDL.Text], ['query']),
    'list_deploys' : IDL.Func([], [IDL.Text], ['query']),
    'report_canister_ready' : IDL.Func([IDL.Text], [IDL.Text], []),
    'verify_realm' : IDL.Func([IDL.Text], [IDL.Text], []),
  });
};
