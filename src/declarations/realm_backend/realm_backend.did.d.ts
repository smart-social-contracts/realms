...
export interface Operation_Mint { 'to' : AccountIdentifier, 'amount' : Tokens }
...
export interface TransferError_TxDuplicate { 'duplicate_of' : BlockIndex }
...
export type UtxosFilter = { 'Page' : Page } |
