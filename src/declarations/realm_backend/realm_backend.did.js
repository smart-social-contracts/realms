export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'join_realm' : IDL.Func([IDL.Text, IDL.Text, IDL.Text], [RealmResponse], []),
    ...
    'set_canister_config' : IDL.Func(
        [IDL.Opt(IDL.Text), IDL.Opt(IDL.Text), IDL.Opt(IDL.Text), IDL.Opt(IDL.Text), IDL.Opt(IDL.Text), IDL.Opt(IDL.Text), IDL.Opt(IDL.Text), IDL.Opt(IDL.Text)],
        [RealmResponse],
        [],
      ),
