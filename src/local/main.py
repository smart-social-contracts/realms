...
from ggg.base import initialize, universe, audit
from api.api import (
...
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": "*"}}, methods=["GET", "POST", "OPTIONS"])  # Allow all methods including POST
...
def run_code():
    ...
    source_code = request.data.decode('ascii')  # utf-8')  # Decode the binary data to a string
