			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
				...
				<div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-900/30">
					...
					<div class="mt-2 text-sm font-medium">
						<span class="text-yellow-600 dark:text-yellow-400">{summaryData.services_approaching || 0} approaching deadlines</span>
					</div>
				</div>
				...
				<div class="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-100 dark:border-green-900/30">
					...
					<div class="mt-2">
						...
						<p class="text-sm text-gray-600 dark:text-gray-400">Tax records</p>
					</div>
					<div class="mt-2 text-sm font-medium">
						<span class="text-red-600 dark:text-red-400">{summaryData.tax_overdue || 0} overdue payments</span>
					</div>
				</div>
				...
				<div class="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-100 dark:border-purple-900/30">
					...
					<div class="mt-2">
						...
						<p class="text-sm text-gray-600 dark:text-gray-400">Data records</p>
					</div>
					<div class="mt-2 text-sm font-medium">
						<span class="text-blue-600 dark:text-blue-400">{summaryData.personal_data_updated || 0} recently updated</span>
					</div>
				</div>
			</div>
		</Card>
