export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'list_packages' : IDL.Func([], [IDL.Text], ['query']),
    'lock_package' : IDL.Func([IDL.Text], [IDL.Text], []),
    'unlock_package' : IDL.Func([IDL.Text], [IDL.Text], []),
    'transfer_package' : IDL.Func([IDL.Text], [IDL.Text], []),
