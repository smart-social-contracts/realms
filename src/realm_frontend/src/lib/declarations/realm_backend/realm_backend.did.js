export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'finalize_federal_vote' : IDL.Func([IDL.Text], [IDL.Text], []),
    ...
    'get_setup_draft_asset' : IDL.Func([IDL.Text], [IDL.Text], ['query']),
    'get_setup_launch_status' : IDL.Func([], [IDL.Text], ['query']),
    ...
    'list_federal_votes' : IDL.Func([IDL.Text], [IDL.Text], ['query']),
    'list_position_holders' : IDL.Func([], [IDL.Text], ['query']),
    ...
    'propose_federal_vote' : IDL.Func([IDL.Text], [IDL.Text], []),
    'receive_realm_message' : IDL.Func(
        [IDL.Text, IDL.Text, IDL.Text, IDL.Text],
        [IDL.Text],
        [],
      ),
    'reconcile_treasury_token' : IDL.Func([], [IDL.Text], []),
    ...
    'report_quarter_ready' : IDL.Func([], [IDL.Text], []),
    ...
    'set_quarter_catalog_status' : IDL.Func(
        [IDL.Text, IDL.Text],
        [IDL.Text],
        [],
      ),
    ...
    'setup_save_draft' : IDL.Func([IDL.Text], [IDL.Text], []),
    'setup_set_branding' : IDL.Func([IDL.Text], [IDL.Text], []),
