...
<Sidebar
	...
	asideClass="fixed inset-0 z-30 flex-none h-full w-64 lg:h-auto lg:top-16 lg:left-0 lg:inset-auto border-e border-gray-200 dark:border-gray-600 lg:overflow-y-visible lg:pt-0 lg:block"
>
