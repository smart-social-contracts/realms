<script>
  ...
  import PackageManagerPanel from '$lib/components/ggg/PackageManagerPanel.svelte';
  ...
  const entityConfigs = [
    { name: 'users', fetch: (page_num = 0, page_size = 5) => quarterBackend.get_users(page_num, page_size), dataPath: 'UsersList.users', paginationPath: 'UsersList.pagination', page: () => usersPage, perPage: () => usersPerPage, pagination: () => usersPagination, onPageChange: handleUsersPageChange },
    { name: 'mandates', fetch: (page_num = 0, page_size = 5) => quarterBackend.get_mandates(page_num, page_size), dataPath: 'MandatesList.mandates', paginationPath: 'MandatesList.pagination', page: () => mandatesPage, perPage: () => mandatesPerPage, pagination: () => mandatesPagination, onPageChange: handleMandatesPageChange },
    { name: 'tasks', fetch: (page_num = 0, page_size = 5) => quarterBackend.get_tasks(page_num, page_size), dataPath: 'TasksList.tasks', paginationPath: 'TasksList.pagination', page: () => tasksPage, perPage: () => tasksPerPage, pagination: () => tasksPagination, onPageChange: handleTasksPageChange },
    { name: 'transfers', fetch: (page_num = 0, page_size = 5) => quarterBackend.get_transfers(page_num, page_size), dataPath: 'TransfersList.transfers', paginationPath: 'TransfersList.pagination', page: () => transfersPage, perPage: () => transfersPerPage, pagination: () => transfersPagination, onPageChange: handleTransfersPageChange },
    { name: 'instruments', fetch: (page_num = 0, page_size = 5) => quarterBackend.get_instruments(page_num, page_size), dataPath: 'InstrumentsList.instruments', paginationPath: 'InstrumentsList.pagination', page: () => instrumentsPage, perPage: () => instrumentsPerPage, pagination: () => instrumentsPagination, onPageChange: handleInstrumentsPageChange },
    { name: 'codexes', fetch: (page_num = 0, page_size = 5) => quarterBackend.get_codexes(page_num, page_size), dataPath: 'CodexesList.codexes', paginationPath: 'CodexesList.pagination', page: () => codexesPage, perPage: () => codexesPerPage, pagination: () => codexesPagination, onPageChange: handleCodexesPageChange },
    { name: 'organizations', fetch: (page_num = 0, page_size = 5) => quarterBackend.get_organizations(page_num, page_size), dataPath: 'OrganizationsList.organizations', paginationPath: 'OrganizationsList.pagination', page: () => organizationsPage, perPage: () => organizationsPerPage, pagination: () => organizationsPagination, onPageChange: handleOrganizationsPageChange },
    { name: 'disputes', fetch: (page_num = 0, page_size = 5) => quarterBackend.get_disputes(page_num, page_size), dataPath: 'DisputesList.disputes', paginationPath: 'DisputesList.pagination', page: () => disputesPage, perPage: () => disputesPerPage, pagination: () => disputesPagination, onPageChange: handleDisputesPageChange },
    { name: 'licenses', fetch: (page_num = 0, page_size = 5) => quarterBackend.get_licenses(page_num, page_size), dataPath: 'LicensesList.licenses', paginationPath: 'LicensesList.pagination', page: () => licensesPage, perPage: () => licensesPerPage, pagination: () => licensesPagination, onPageChange: handleLicensesPageChange },
    { name: 'trades', fetch: (page_num = 0, page_size = 5) => quarterBackend.get_trades(page_num, page_size), dataPath: 'TradesList.trades', paginationPath: 'TradesList.pagination', page: () => tradesPage, perPage: () => tradesPerPage, pagination: () => tradesPagination, onPageChange: handleTradesPageChange },
    { name: 'realms', fetch: (page_num = 0, page_size = 5) => quarterBackend.get_realms(page_num, page_size), dataPath: 'RealmsList.realms', paginationPath: 'RealmsList.pagination', page: () => realmsPage, perPage: () => realmsPerPage, pagination: () => realmsPagination, onPageChange: handleRealmsPageChange },
    { name: 'proposals', fetch: (page_num = 0, page_size = 5) => quarterBackend.get_proposals(page_num, page_size), dataPath: 'ProposalsList.proposals', paginationPath: 'ProposalsList.pagination', page: () => proposalsPage, perPage: () => proposalsPerPage, pagination: () => proposalsPagination, onPageChange: handleProposalsPageChange },
    { name: 'votes', fetch: (page_num = 0, page_size = 5) => quarterBackend.get_votes(page_num, page_size), dataPath: 'VotesList.votes', paginationPath: 'VotesList.pagination', page: () => votesPage, perPage: () => votesPerPage, pagination: () => votesPagination, onPageChange: handleVotesPageChange },
  ];
