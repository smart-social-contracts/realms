...
class MenuCategoryConfig(Entity):
    ...
    def __init__(self, *, id: str, category_id: Optional[str] = ..., label: Optional[str] = ..., position: int = ..., **kwargs) -> None: ...
    @classmethod
    def instances(cls) -> List["MenuCategoryConfig"]: ...
    @classmethod
    def all(cls) -> List["MenuCategoryConfig"]: ...
    @classmethod
    def count(cls) -> int: ...
    @classmethod
    def create(cls, **kwargs) -> "MenuCategoryConfig": ...
    def delete(self) -> None: ...
    def save(self) -> None: ...
    def __class_getitem__(cls, alias_value: str) -> Optional["MenuCategoryConfig"]: ...


class MenuItemConfig(Entity):
    ...
    def __init__(self, *, id: str, extension_name: Optional[str] = ..., category_id: Optional[str] = ..., position: int = ..., **kwargs) -> None: ...
    @classmethod
    def instances(cls) -> List["MenuItemConfig"]: ...
    @classmethod
    def all(cls) -> List["MenuItemConfig"]: ...
    @classmethod
    def count(cls) -> int: ...
    @classmethod
    def create(cls, **kwargs) -> "MenuItemConfig": ...
    def delete(self) -> None: ...
    def save(self) -> None: ...
    def __class_getitem__(cls, alias_value: str) -> Optional["MenuItemConfig"]: ...


class MenuDepartmentVisibility(Entity):
    ...
    def __init__(self, *, id: str, extension_name: Optional[str] = ..., department: Optional[Department] = ..., visible: bool = ..., **kwargs) -> None: ...
    @classmethod
    def instances(cls) -> List["MenuDepartmentVisibility"]: ...
    @classmethod
    def all(cls) -> List["MenuDepartmentVisibility"]: ...
    @classmethod
    def count(cls) -> int: ...
    @classmethod
    def create(cls, **kwargs) -> "MenuDepartmentVisibility": ...
    def delete(self) -> None: ...
    def save(self) -> None: ...
    def __class_getitem__(cls, alias_value: str) -> Optional["MenuDepartmentVisibility"]: ...
