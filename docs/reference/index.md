...
- **[Operations](../OPERATIONS)** — Publish-build → rollout (preferred deploy path; see also `AGENTS.md` in repo root)
- **[Operations](../OPERATIONS)** — The product orchestra: build, `casals up`, checks
...
**Realm Operators**
- [Operations](../OPERATIONS) — Deploy and upgrade realms (see `AGENTS.md` in repo root)
