...
1. **`multisig_mint`** — authorize `orchestration-multisig@1.4.0`, mint or adopt the `System/governance/multisig` canister from `realms/casals.json`. Casals mints it from its own cycles.
