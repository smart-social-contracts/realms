...
def test_task_manager_basic():
    ...
    try:
        from core.task_manager import QueuedTask, TaskManager, TaskStatus
...
def test_cron_functionality():
    ...
    try:
        ...
        assert tm._should_run_cron(
            minute_expr, current_time
        ), "Current minute should match"
        ...
        assert not tm._should_run_cron(
            non_match_expr, current_time
