...
class TestCursorDatabaseExplorer:
    ...
    def test_render_record_detail(self):
        ...
        org_nav_item = next((item for item in nav_items if item['key'] == 'organization_id'), None)
    ...
    def test_dynamic_entity_discovery(self):
        ...
        for entity in common_entities:
            assert entity in discovered_entities, f"Entity '{entity}' should be discovered"
