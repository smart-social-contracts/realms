...
def test_ps_ls_command_with_tasks():
    ...
    with patch('cli.realms_cli.commands.ps.call_canister_endpoint', return_value=mock_tasks):
        with patch('cli.realms_cli.commands.ps.console'):
            # Should not raise exception
...
def test_ps_ls_command_error():
    ...
    with patch('cli.realms_cli.commands.ps.call_canister_endpoint', return_value={"error": "Test error"}):
        with patch('cli.realms_cli.commands.ps.console'):
...
def test_ps_kill_command_success():
    ...
    with patch('cli.realms_cli.commands.ps.call_canister_endpoint', return_value=mock_response):
        with patch('cli.realms_cli.commands.ps.console'):
            # Should not raise exception
