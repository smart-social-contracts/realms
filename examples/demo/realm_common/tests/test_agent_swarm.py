...
PERSONA_ROSTER: List[PersonaSlot] = [
    ...
    PersonaSlot(
        ...
        task=(
            ...
            "3. Call registry_deploy_realm with your principal and ALL of these fields:\n"
            "   - realm_name: a creative, unique name (add a short random suffix, e.g. 'Aurora_7kx')\n"
            "   - description: a compelling 1-2 sentence vision that would attract citizens\n"
            "   - welcome_message: a warm greeting for new members\n"
            "   - logo_url: pick ONE emblem from the list below\n"
            "   - welcome_image_url: pick ONE background from the list below\n"
            "   Available emblems (pick one that fits your realm's theme):\n"
            "     https://raw.githubusercontent.com/smart-social-contracts/realms/main/examples/demo/realm1/emblem.png\n"
            "     https://raw.githubusercontent.com/smart-social-contracts/realms/main/examples/demo/realm2/emblem.png\n"
            "     https://raw.githubusercontent.com/smart-social-contracts/realms/main/examples/demo/realm3/emblem.png\n"
            "     https://raw.githubusercontent.com/smart-social-contracts/realms/main/examples/demo/realm_new/emblem.png\n"
            "   Available backgrounds (pick one):\n"
            "     https://raw.githubusercontent.com/smart-social-contracts/realms/main/examples/demo/realm1/background.png\n"
            "     https://raw.githubusercontent.com/smart-social-contracts/realms/main/examples/demo/realm2/background.png\n"
            "     https://raw.githubusercontent.com/smart-social-contracts/realms/main/examples/demo/realm3/background.png\n"
            "     https://raw.githubusercontent.com/smart-social-contracts/realms/main/examples/demo/realm_new/background.png\n"
            ...
            "5. Describe your realm's governance model and what founding proposals you would submit.\n"
